 ...
 */
package com.wangyi.component.uid.core.impl;

import com.wangyi.component.uid.core.BitsAllocator;
import com.wangyi.component.uid.core.UidGenerator;
import com.wangyi.component.uid.core.exception.UidGenerateException;
import com.wangyi.component.uid.core.resposity.WorkerIdAssigner;
import com.wangyi.component.uid.core.utils.DateUtil;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    public String parseUID(long uid) {
        ...
        String thatTimeStr = DateUtil.date2String( thatTime, DateUtil.DATE_PATTERN.YYYY_MM_DD_HH_MM_SS );
    ...
    public void setEpochStr(String epochStr) {
        if (StringUtils.isNotBlank( epochStr )) {
            ...
            this.epochSeconds = TimeUnit.MILLISECONDS.toSeconds( DateUtil.string2Date( epochStr ).getTime() );
        }
    }
}
