...
import com.wangyi.component.uid.core.utils.DockerUtils;
import com.wangyi.component.uid.core.utils.NetUtils;
...
public class DisposableWorkerIdAssigner implements WorkerIdAssigner {
    ...
    private WorkerNodeEntity buildWorkerNode() {
        ...
        if (DockerUtils.isDocker()) {
            ...
            workerNodeEntity.setPort( System.currentTimeMillis() + "-" + RandomUtils.randomInt( 0, 100000 ) );
        }
